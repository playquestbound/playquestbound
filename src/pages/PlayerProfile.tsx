            ...
            >
                ...
                >
                  ...
                  <svg viewBox="0 0 56 56" className="w-full h-full">
                    ...
                    <path 
                      ...
                      fill="url(#gemGradientPlayer)"
                      stroke="hsl(220 35% 35%)"
                      strokeWidth="2"
                    />
                    <path 
                      d="M28 6 L50 28 L28 16 L6 28 Z" 
                      fill="url(#gemShinePlayer)"
                    />
                  </svg>
              ...
              <div className="relative -mt-2 mb-2">
                <svg viewBox="0 0 320 50" className="w-full h-12" preserveAspectRatio="none">
                  <defs>
                    <linearGradient id="ribbonGradientPlayer" x1="0%" y1="0%" x2="0%" y2="100%">
                      <stop offset="0%" stopColor="hsl(220 35% 28%)" />
                      <stop offset="50%" stopColor="hsl(220 30% 20%)" />
                      <stop offset="100%" stopColor="hsl(220 35% 15%)" />
                    </linearGradient>
                    <linearGradient id="ribbonEdgePlayer" x1="0%" y1="0%" x2="0%" y2="100%">
                      <stop offset="0%" stopColor="hsl(220 25% 12%)" />
                      <stop offset="100%" stopColor="hsl(220 30% 8%)" />
                    </linearGradient>
                  </defs>
                  {/* Left ribbon tail */}
                  <path d="M0 20 L30 15 L30 35 L0 30 L10 25 Z" fill="url(#ribbonEdgePlayer)" />
                  {/* Right ribbon tail */}
                  <path d="M320 20 L290 15 L290 35 L320 30 L310 25 Z" fill="url(#ribbonEdgePlayer)" />
                  {/* Main ribbon */}
                  <path d="M20 10 L300 10 L290 25 L300 40 L20 40 L30 25 Z" fill="url(#ribbonGradientPlayer)" stroke="hsl(220 35% 35%)" strokeWidth="1" />
                </svg>
